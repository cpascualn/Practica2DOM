...
class RestaurantController {
    ...
    onLoad = () => {
        ...
        let cat1 = this[MODEL].createCategory('Carne', 'descrip');
        ...
        let cat2 = this[MODEL].createCategory('Pasta', 'descrip2');
        ...
        let cat3 = this[MODEL].createCategory('Postres', 'descrip3');
